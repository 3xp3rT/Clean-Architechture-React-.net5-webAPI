...
export default function ActivityForm({activity:selectedActivity,closeForm,createOrEdit,submitting}: Props) {
    const inicaialState = selectedActivity ??{
        id:'',
        title:'',
        category:'',
        description:'',
    ...
    const [activity,setActivity]= useState(inicaialState);
...
<Form onSubmit={handleSubmit} autoComplete='off'>
    ...
    <Form.Input placeholder='Vanue'value={activity.venue} name='venue' onChange={handleInputChange}></Form.Input>
